 ...
 */
export const isArray : <T = unknown>(toTest: unknown, itemGuard ?: (toTest: unknown) => toTest is T) => toTest is T[] = <T = unknown>(toTest : unknown, itemGuard ?: (toTest: unknown) => toTest is T) : toTest is T[] =>
{
