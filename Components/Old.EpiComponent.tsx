...
export default class EpiComponent extends Component<EpiComponentProps, EpiComponentState> {
	 ...
	 * @param props 
	 */
	public constructor(props : EpiComponentProps) {
		super(props);
		...
		if (this.isExpandedValueValid()) {
			...
			if (this.spaContext.isDebugActive()) console.debug(`EpiComponent is awaiting full content`, this.props.contentLink)
	...
	public componentDidUpdate(prevProps: EpiComponentProps, prevState: EpiComponentState)
	{
	...
	public static getDerivedStateFromError(error: any) : EpiComponentState
	{
		return {
			hasError: true,
			errorObject: error,
	...
	public static CreateComponent(context: IEpiserverContext) : EpiComponentType
	{
		...
		return connect((state: any, ownProps: EpiComponentProps) : EpiComponentProps => {
			...
			return ownProps;
		})(EpiComponent) as unknown as EpiComponentType;
	}
}