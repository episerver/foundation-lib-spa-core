 ...
 */
var ComponentPreLoader = /** @class */ (function () {
     ...
     */
    ComponentPreLoader.load = function (config, loader) {
        return __awaiter(this, void 0, void 0, function () {
            var list, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(config && config.length > 0)) return [3 /*break*/, 4];
                        list = config.map(function (c) { return loader.LoadType(c).catch(function (e) { return e; }); });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
     ...
     * @param   loader  The ComponentLoader to use
     */
    ComponentPreLoader.isPreLoaded = function (config, loader) {
