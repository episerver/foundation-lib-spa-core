...
exports.FetchAdapter = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var requestUrl, headers, requestConfig, request, r, responseHeaders, response, _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                request = new Request(requestUrl.href, requestConfig);
                return [4 /*yield*/, fetch(request)];
            case 1:
                r = _d.sent();
                responseHeaders = {};
                r.headers.forEach(function (value, name) { return responseHeaders[name] = value; });
                response = {
                    config: config,
                    request: request,
                    status: r.status,
            ...
            case 6:
                ...
                return [3 /*break*/, 8];
            case 7: throw new Error("Unsupported response type: " + config.responseType);
